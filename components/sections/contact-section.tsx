      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight mb-4">
            ¿Tienes un proyecto en <span className="text-gradient">mente</span>?
          </h2>
              ...
              >
                <Card className="border-border/60 bg-card/60 backdrop-blur-sm hover:border-primary/40 transition-colors duration-300 group h-full">
                  <CardContent className="p-6 text-center">
                    <div
                      className={`inline-flex items-center justify-center w-12 h-12 rounded-xl bg-primary/10 ${method.color} mb-4 group-hover:scale-110 transition-transform duration-300`}
                    >
                    ...
                    <Button
                      variant="outline"
                      size="sm"
                      className="bg-transparent hover:border-primary/40 hover:bg-primary/10 transition-colors"
                      asChild
                    >
            ...
            {socialLinks.map((social) => {
              ...
              return (
                <Button
                  ...
                  variant="ghost"
                  size="sm"
                  className={`hover:bg-primary/10 transition-colors ${social.color}`}
                  asChild
                >
